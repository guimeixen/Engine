...
mat4 GetBoneTransform(uint startIndex)
{
	...
	mat4 boneTransform = instanceData[index + boneIDs[0]] * weights[0];
	boneTransform += instanceData[index + boneIDs[1]] * weights[1];
	boneTransform += instanceData[index + boneIDs[2]] * weights[2];
	boneTransform += instanceData[index + boneIDs[3]] * weights[3];
