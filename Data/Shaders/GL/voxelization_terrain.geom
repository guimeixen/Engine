...
layout(location = 4) flat in vec3 colorGeom[];
layout(location = 5) in float roughnessGeom[];

layout(location = 0) out vec2 uv;
layout(location = 1) out vec3 normal;
layout(location = 2) out vec4 lightSpacePos;
layout(location = 3) flat out int axis;
