...
// Called by user code
IMGUI_IMPL_API bool     ImGui_ImplVulkan_Init(Engine::Renderer* renderer, ImGui_ImplVulkan_InitInfo* info, VkRenderPass render_pass);
...
IMGUI_IMPL_API void     ImGUI_ImplVulkan_CreateOrResizeBuffers(VkDeviceSize vertexSize, VkDeviceSize indexSize);
